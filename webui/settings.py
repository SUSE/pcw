...
DATABASES = {
    ...
    'auth_db': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': os.path.join(BASE_DIR, 'db', 'auth.sqlite3'),
    }
}
...
# Taken verbatim from https://docs.djangoproject.com/en/dev/topics/db/multi-db/
class AuthRouter:
    """
...
DATABASE_ROUTERS = ['webui.settings.AuthRouter']
